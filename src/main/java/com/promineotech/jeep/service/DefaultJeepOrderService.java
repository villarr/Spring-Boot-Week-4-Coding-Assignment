...
public class DefaultJeepOrderService implements JeepOrderService {
	...
	public Order createOrder(OrderRequest orderRequest) {
		...
		Jeeps model = getModel(orderRequest);
		...
		BigDecimal price = model.getBasePrice().add(color.getPrice())
		...
		return jeepOrderDao.saveOrder(customer, model, 
				color, engine, tire, price, options);
	}
	  /**
	   * 
	   * @param orderRequest
	   ...
	   * @return
	   */
	  private Jeeps getModel(OrderRequest orderRequest) {
	    return jeepOrderDao
